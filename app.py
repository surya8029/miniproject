...
with header:
    st.title("welcome to my awsome app")
...
features = [company_of_laptop, name_of_the_processor, type_of_the_processor, generation, ram_in_gb, ddr_version,
            type_of_os, type_of_diskdrive, size_in_inches, graphic_card, touchscreen]
